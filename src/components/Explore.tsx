        ...
        <div className="w-full max-w[1920px] mx-auto px-4 py-12 md:py-20">
            ...
            <section className="mb-16 md:mb-24">
                ...
                <p className="text-gray-600 text-center max-w-3xl mx-auto mb-12">
                    There are many variations of passenger of available but the majority have suffered
                    alteration in some form by injected hutter or random weed which don't look even.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                        ...
                        <p className="text-gray-600">
                            These are variation You need to be sure there is anything hidden in the middle of text.
                        </p>
                    </div>
